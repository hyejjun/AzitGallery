...
const AddItemComponent = () => {
    ...
    */
    ...
    const createNFTconfirmed = () => {
        let data = {}
        if (ifSell == true) {
            data = { ifSell, price, currency, name, desc, gender, bigCategory, smallCategory, totalColorSizeQty, mainImgIdx, }
        } else {
            data = { ifSell, name, desc, aucPrice, currency, aucTime, extension, gender, bigCategory, smallCategory, totalColorSizeQty, mainImgIdx, }
        }
